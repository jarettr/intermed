//! Item Modifier domain (`data/<ns>/item_modifier[s]/<path>.json`).
...
pub const ITEM_MODIFIER_AST_VERSION: &str = "item-modifier-r2";

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct ItemModifierSummary {
...
pub fn parse(value: &Value) -> DomainParse {
    ...
    DomainParse {
        summary: ResourceSummary::ItemModifier(ItemModifierSummary {
