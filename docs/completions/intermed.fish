...
complete -c intermed -n "__fish_intermed_needs_command" -f -a "deps" -d 'Layer-C dependency graph, resolution, and explainable queries'
complete -c intermed -n "__fish_intermed_needs_command" -f -a "impact" -d 'Blast-radius analysis for removing or updating a mod'
...
complete -c intermed -n "__fish_intermed_using_subcommand vfs; and __fish_seen_subcommand_from overlay" -l config -d 'Config file (`intermed-config-v1` TOML). Overrides discovery; see docs/reference/configuration.md' -r -F
...
complete -c intermed -n "__fish_intermed_using_subcommand deps; and not __fish_seen_subcommand_from graph resolve why why-missing implicit path help" -f -a "graph" -d 'Export the modpack dependency graph (`intermed-modpack-graph-v1` JSON)'
complete -c intermed -n "__fish_intermed_using_subcommand deps; and not __fish_seen_subcommand_from graph resolve why why-missing implicit path help" -f -a "resolve" -d 'Run PubGrub resolution and emit `intermed-deps-resolution-v1` JSON'
complete -c intermed -n "__fish_intermed_using_subcommand deps; and not __fish_seen_subcommand_from graph resolve why why-missing implicit path help" -f -a "why" -d 'Explain why a mod/namespace is depended upon (declared + implicit reasons)'
complete -c intermed -n "__fish_intermed_using_subcommand deps; and not __fish_seen_subcommand_from graph resolve why why-missing implicit path help" -f -a "why-missing" -d 'Explain why an absent dependency is required (the requiring edges)'
complete -c intermed -n "__fish_intermed_using_subcommand deps; and not __fish_seen_subcommand_from graph resolve why why-missing implicit path help" -f -a "implicit" -d 'List implicit references into a namespace (resource-derived dependencies)'
complete -c intermed -n "__fish_intermed_using_subcommand deps; and not __fish_seen_subcommand_from graph resolve why why-missing implicit path help" -f -a "path" -d 'Find a dependency chain between two mods (`deps path <from> <to>`)'
...
complete -c intermed -n "__fish_intermed_using_subcommand deps; and __fish_seen_subcommand_from implicit" -l namespace -d 'The provider namespace to list implicit references for' -r
...
complete -c intermed -n "__fish_intermed_using_subcommand deps; and __fish_seen_subcommand_from help" -f -a "why" -d 'Explain why a mod/namespace is depended upon (declared + implicit reasons)'
complete -c intermed -n "__fish_intermed_using_subcommand deps; and __fish_seen_subcommand_from help" -f -a "why-missing" -d 'Explain why an absent dependency is required (the requiring edges)'
complete -c intermed -n "__fish_intermed_using_subcommand deps; and __fish_seen_subcommand_from help" -f -a "implicit" -d 'List implicit references into a namespace (resource-derived dependencies)'
...
complete -c intermed -n "__fish_intermed_using_subcommand impact; and not __fish_seen_subcommand_from remove update help" -f -a "remove" -d 'Blast radius of removing a mod (reverse resource graph + dependents)'
complete -c intermed -n "__fish_intermed_using_subcommand impact; and not __fish_seen_subcommand_from remove update help" -f -a "update" -d 'Blast radius of bumping a mod\'s version (which declared ranges reject it)'
complete -c intermed -n "__fish_intermed_using_subcommand impact; and not __fish_seen_subcommand_from remove update help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c intermed -n "__fish_intermed_using_subcommand impact; and __fish_seen_subcommand_from help" -f -a "remove" -d 'Blast radius of removing a mod (reverse resource graph + dependents)'
complete -c intermed -n "__fish_intermed_using_subcommand impact; and __fish_seen_subcommand_from help" -f -a "update" -d 'Blast radius of bumping a mod\'s version (which declared ranges reject it)'
complete -c intermed -n "__fish_intermed_using_subcommand impact; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c intermed -n "__fish_intermed_using_subcommand rules; and not __fish_seen_subcommand_from check generate sign verify update registry install explain help" -f -a "check" -d 'Validate rule-pack JSON/YAML files under a path'
complete -c intermed -n "__fish_intermed_using_subcommand rules; and not __fish_seen_subcommand_from check generate sign verify update registry install explain help" -f -a "generate" -d 'Generate backend artifacts (SQL, Datalog, Rust stubs) from a rule pack'
complete -c intermed -n "__fish_intermed_using_subcommand rules; and not __fish_seen_subcommand_from check generate sign verify update registry install explain help" -f -a "sign" -d 'Sign a v2 rule pack with an Ed25519 key'
complete -c intermed -n "__fish_intermed_using_subcommand rules; and not __fish_seen_subcommand_from check generate sign verify update registry install explain help" -f -a "verify" -d 'Verify a signed rule pack (optional trusted-keys file)'
complete -c intermed -n "__fish_intermed_using_subcommand rules; and not __fish_seen_subcommand_from check generate sign verify update registry install explain help" -f -a "update" -d 'Refresh an installed pack from the registry (embedded core by default)'
complete -c intermed -n "__fish_intermed_using_subcommand rules; and not __fish_seen_subcommand_from check generate sign verify update registry install explain help" -f -a "registry" -d 'List packs in a registry index (embedded default if omitted)'
complete -c intermed -n "__fish_intermed_using_subcommand rules; and not __fish_seen_subcommand_from check generate sign verify update registry install explain help" -f -a "install" -d 'Install a pack and its registry dependencies into XDG rule-packs'
complete -c intermed -n "__fish_intermed_using_subcommand rules; and not __fish_seen_subcommand_from check generate sign verify update registry install explain help" -f -a "explain" -d 'Show the query-engine plan (EXPLAIN, and EXPLAIN ANALYZE with `--facts`) per rule'
complete -c intermed -n "__fish_intermed_using_subcommand rules; and not __fish_seen_subcommand_from check generate sign verify update registry install explain help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "doctor" -d 'Diagnose a server, instance, mods directory, or log/crash file'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "vfs" -d 'Inspect resource/data overrides and generate overlay previews'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "deps" -d 'Layer-C dependency graph, resolution, and explainable queries'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "impact" -d 'Blast-radius analysis for removing or updating a mod'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "mixin-map" -d 'Inspect static Mixin targets, overlaps, and overwrite risks'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "spark-map" -d 'Import and summarize Spark performance reports'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "lab" -d 'Compatibility Lab: corpus locks, smoke-test ingestion, matrices'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "rules" -d 'Validate declarative rule packs'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "db" -d 'Query the DuckDB analytics store (`--features duckdb`)'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "history" -d 'Recurring conflicts across persisted diagnosis runs'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "trends" -d 'Time-series analytics over persisted runs'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "cache" -d 'Jar scan cache maintenance (`stats`, `prune`, `clear`)'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "sbom" -d 'SBOM export (SPDX / CycloneDX) from a mods directory'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "demo" -d 'Presentation demo: aggregate a small real-mod run into launcher-facing reports'
complete -c intermed -n "__fish_intermed_using_subcommand help; and not __fish_seen_subcommand_from doctor vfs deps impact mixin-map spark-map lab rules db history trends cache sbom demo help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c intermed -n "__fish_intermed_using_subcommand help; and __fish_seen_subcommand_from deps" -f -a "why" -d 'Explain why a mod/namespace is depended upon (declared + implicit reasons)'
complete -c intermed -n "__fish_intermed_using_subcommand help; and __fish_seen_subcommand_from deps" -f -a "why-missing" -d 'Explain why an absent dependency is required (the requiring edges)'
complete -c intermed -n "__fish_intermed_using_subcommand help; and __fish_seen_subcommand_from deps" -f -a "implicit" -d 'List implicit references into a namespace (resource-derived dependencies)'
complete -c intermed -n "__fish_intermed_using_subcommand help; and __fish_seen_subcommand_from deps" -f -a "path" -d 'Find a dependency chain between two mods (`deps path <from> <to>`)'
...
complete -c intermed -n "__fish_intermed_using_subcommand help; and __fish_seen_subcommand_from rules" -f -a "explain" -d 'Show the query-engine plan (EXPLAIN, and EXPLAIN ANALYZE with `--facts`) per rule'
